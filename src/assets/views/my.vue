<template>
    <div class="wrapper">
        ...
        <div :class="['header', isIpx&&isIpx()?'h-ipx':'']"  @click="jumpWeb('http://m.you.163.com/ucenter')">
            <image class="i-photo" resize="cover" src="https://avatars1.githubusercontent.com/u/19256823?s=40&amp;v=4"></image>
            <text class="i-name">曹大爷</text>
            <div class="b-tlt">
        ...
        <div class="fbs">
            <div >
                ...
                <div class="box-line">
                    <div class="i-box-l">
                        ...
                        <text class="i-box-tlt">贷款</text>
                    </div>
                    <div class="i-box-l">
                        <text class="i-box-icon iconfont">&#xe675;</text>
                        <text class="i-box-tlt">理财</text>
                    </div>
                    <div class="i-box-l">
                        <text class="i-box-icon iconfont">&#xe671;</text>
                        <text class="i-box-tlt">保险</text>
                    </div>
                    <div class="i-box-l">
                        <text class="i-box-icon iconfont">&#xe672;</text>
                        <text class="i-box-tlt">信用卡</text>
                    </div>
                </div>
            </div>
            ...
            <div class="s-box cell-button">
                ...
                <div class="box-line line-serve border-bottom" @click="jumpWeb('https://id.163.com/gj/m/')">
                    <div class="i-box-l"><text class="i-box-icon iconfont i-c-orange">&#xe658;</text><text class="i-box-tlt">话费充值</text></div>
                    <div class="i-box-l"><text class="i-box-icon iconfont i-c-yellow">&#xe61d;</text><text class="i-box-tlt">流量购买</text></div>
                    <div class="i-box-l"><text class="i-box-icon iconfont i-c-orange">&#xef12;</text><text class="i-box-tlt">米币充值</text></div>
                    <div class="i-box-l"><text class="i-box-icon iconfont i-c-yellow">&#xe615;</text><text class="i-box-tlt">生活缴费</text></div>
                </div>
